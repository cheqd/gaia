...
import (
	...
	simulation2 "github.com/cheqd/cosmos-sdk/types/simulation"
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/cheqd/cosmos-sdk/GaiaApp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
